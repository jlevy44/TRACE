...
share_image_button = tk.Button(root, text="1. Upload Docker Image (only once)", command=share_docker_image)
share_image_button.grid(row=0, column=0, padx=10, pady=10, sticky="nsew")

generate_button = tk.Button(root, text="2. Set Project Folder", command=generate_folders)
generate_button.grid(row=0, column=1, padx=10, pady=10, sticky="nsew")

set_port_button = tk.Button(root, text="3. Set Port", command=set_port)
set_port_button.grid(row=1, column=0, padx=10, pady=10, sticky="nsew")

run_button = tk.Button(root, text="4. Run TRACE", command=run_application)
run_button.grid(row=1, column=1, padx=10, pady=10, sticky="nsew")

# Add the quit button to terminate the subprocess
quit_button = tk.Button(root, text="Quit TRACE", command=quit_application)
quit_button.grid(row=2, column=0, columnspan=2, padx=10, pady=10, sticky="nsew")
